...
public class SL_TestCasesTest2 {
	...
	public void inventoryTest() {
		invSort.login(driver, username, pwd);
		invSort.inventory(driver, sorting);
    ...
    public static Collection<Object[]> data() {
        ...
        Object[][] credentials = new Object[rowCount][4];
        	for(int i=0;i<rowCount;i++) {
        		credentials[i][0]=xlsR.getCellData(sheetName, 4, i+2);
        		credentials[i][1]=xlsR.getCellData(sheetName, 5, i+2);
    			credentials[i][2]=xlsR.getCellData(sheetName, 1, 2);	
    			credentials[i][3]=xlsR.getCellData(sheetName, 2, 2);
    		}
